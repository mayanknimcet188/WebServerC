...
int main()
{
  ...
  // Creates the queues
  // Listen for clients, with 10 blocking, with 10 backlog (10 connections in accept queue)
  ...
  while (1)
  {
    ...
    // We send the response by writing to the socket send buffer in the OS
